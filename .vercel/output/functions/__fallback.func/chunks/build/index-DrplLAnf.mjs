...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "viewing-rooms",
      () => queryCollection("viewingRooms").all()
      // NOTE: viewingRooms (no hyphen)
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)}><h1 class="text-2xl font-semibold mb-4">Viewing Rooms</h1><ul class="grid gap-3"><!--[-->`);
      ssrRenderList(unref(items), (doc) => {
        _push(`<li>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/viewing-rooms/${doc.slug}`
        }, {
        ...
        _push(`<small class="block opacity-60">${ssrInterpolate(doc.startDate)} `);
        if (doc.endDate) {
          _push(`<span> — ${ssrInterpolate(doc.endDate)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</small></li>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/viewing-rooms/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DrplLAnf.mjs.map
