...
import { aJ as pascalCase, aK as kebabCase, x as destr } from '../nitro/nitro.mjs';
...
const virtual_nuxt__2FUsers_2Fmamthenebo_2FMe_2Fprojects_2FogalleryFront_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  globalComponents,
  localComponents
}, Symbol.toStringTag, { value: "Module" }));
    ...
    function resolveVueComponent(component) {
      ...
      if (typeof component === "string") {
        ...
        if (globalComponents.includes(pascalCase(component))) {
          ...
          const loader = () => {
            return Promise.resolve().then(() => virtual_nuxt__2FUsers_2Fmamthenebo_2FMe_2Fprojects_2FogalleryFront_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents).then((m) => {
...
//# sourceMappingURL=ContentRenderer-Dbz4REXS.mjs.map
