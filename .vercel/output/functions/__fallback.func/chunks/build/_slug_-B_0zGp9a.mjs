import { _ as __nuxt_component_0 } from './ContentRenderer-Dbz4REXS.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(page)) {
        _push(`<article${ssrRenderAttrs(_attrs)}><h1 class="text-3xl font-semibold mb-2">${ssrInterpolate(unref(page).title)}</h1><p class="opacity-70 mb-6">${ssrInterpolate(unref(page).date)}</p>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/publications/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_slug_-B_0zGp9a.mjs.map
