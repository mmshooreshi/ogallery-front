...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead({
      title: doc.value?.title || "Viewing Room"
    });
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(doc)) {
        _push(`<article${ssrRenderAttrs(_attrs)}><h1 class="text-3xl font-semibold mb-2">${ssrInterpolate(unref(doc).title)}</h1><p class="opacity-70 mb-6">${ssrInterpolate(unref(doc).startDate)} `);
        ...
        if (unref(doc).text) {
          ...
          ssrRenderList((unref(doc).text || "").split("\n\n"), (p) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/viewing-rooms/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_slug_-ByBSMXES.mjs.map
