...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)}><h1 class="text-2xl font-semibold mb-4">Publications</h1><ul class="grid gap-3"><!--[-->`);
      ssrRenderList(unref(items), (doc) => {
        _push(`<li>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/publications/${doc.slug}`
        }, {
...
//# sourceMappingURL=index-DFdWVpV4.mjs.map
