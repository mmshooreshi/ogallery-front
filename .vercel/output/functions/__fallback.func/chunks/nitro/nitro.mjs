...
import { resolve as resolve$2, dirname, relative as relative$1, join } from 'node:path';
...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2025-09-08T23:43:53.371Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2025-09-08T23:43:53.371Z"}
  }
};
...
const unstorage_47drivers_47fs = defineDriver((userOptions = {}) => {
  ...
  const base = resolve$2(userOptions.base);
...
storage$1.mount('content', unstorage_47drivers_47fs({"driver":"fs","base":"content"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "7fa69475-f195-48da-b11e-982c2e48d859",
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/artists/sql_dump.txt": {
        "prerender": true
      },
      "/__nuxt_content/exhibitions/sql_dump.txt": {
        "prerender": true
      },
      "/__nuxt_content/window/sql_dump.txt": {
        "prerender": true
      },
      "/__nuxt_content/viewingRooms/sql_dump.txt": {
        "prerender": true
      },
      "/__nuxt_content/publications/sql_dump.txt": {
        "prerender": true
      },
      "/__nuxt_content/news/sql_dump.txt": {
        "prerender": true
      },
      "/__nuxt_content/studio/sql_dump.txt": {
        "prerender": true
      },
      "/sitemap_index.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2025-09-08T23:43:53.318Z"
        }
      },
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/mamthenebo/Me/projects/ogallery-front/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-scripts": {
...
const _hgwJU_yVkMXbPesopviinMrHqZF1STmQP_ntqAMJg = defineNitroPlugin(async (nitroApp) => {
...
const _ntUT60uTlmpto3QmmpOfhqfoxUqFbz8MegrJcXpGOgk = defineNitroPlugin(async (nitroApp) => {
...
const theme = {"fontFamily":{"english":"Dosis, sans-serif","persian":"Vazir, sans-serif"}};
...
const _cQl98Ck1vfH2XpnmeDAfA7qGbpGb4NsMWH30xL6_6_c = defineNitroPlugin(async (nitro) => {
  return;
});
...
const appHead = {"link":[{"rel":"icon","type":"image/x-icon","href":"/favicons/favicon.ico"},{"rel":"manifest","href":"/favicons/site.webmanifest"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"OGallery official website"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"titleTemplate":"%s - OGallery","htmlAttrs":{}};
...
const pathToI18nConfig = {
  ...
  "/viewing-rooms/:slug()": {
    "en": "/viewing-rooms/:slug()",
    "fa": "/viewing-rooms/:slug()"
  },
  "/ndefined": {
    "en": "/ndefined",
    "fa": "/ndefined"
...
const i18nPathToPath = {
  ...
  "/exhibitions/:slug()": "/exhibitions/:slug()",
  "/publications": "/publications",
  "/publications/:slug()": "/publications/:slug()",
  "/viewing-rooms": "/viewing-rooms",
  "/viewing-rooms/:slug()": "/viewing-rooms/:slug()",
  "/ndefined": "/ndefined"
};
...
const _lw_YbKEIA61UP5xYDhIrFReHz8NPxFIl_3r0qw_hFk = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const _BtcT_g7rkmq55I_OoWrU1yoNKvbko25WA9XSJ3uY45w = (function(nitro) {
...
const plugins = [
  _hgwJU_yVkMXbPesopviinMrHqZF1STmQP_ntqAMJg,
_ntUT60uTlmpto3QmmpOfhqfoxUqFbz8MegrJcXpGOgk,
_cQl98Ck1vfH2XpnmeDAfA7qGbpGb4NsMWH30xL6_6_c,
_lw_YbKEIA61UP5xYDhIrFReHz8NPxFIl_3r0qw_hFk,
_BtcT_g7rkmq55I_OoWrU1yoNKvbko25WA9XSJ3uY45w
];
...
const checksums = {
  "content": "v3.5.0--PJ58IAw-FOfWZA725ZYHnIub3ObJ2K_kKxshd7s90G0",
  "artists": "v3.5.0--Td4piOsk7wtlZIEwWjZqL7JU3wKB_U0zNd_2sU-BK3k",
  "exhibitions": "v3.5.0--cV2VfK9p43JsH1AWrlgtDAkEJ0DnbkliIsxikUYgUNE",
  "window": "v3.5.0--pjPCyCR86p5u3ZTTnsHPByNEUDC-HDbm-hc56TEH5o8",
  "viewingRooms": "v3.5.0--FVeVYrZrUDggwkCLrT7CoQOw1bpKfP_aDaN0twwrPw8",
  "publications": "v3.5.0--JcmKhQDvSYEV3I5usZvkNUp6cKtUwL_aAN28MBWcvPI",
  "news": "v3.5.0--AFTFflqRXPekXdWdgI6ZKXw5mcjKQCgukH2j6ONZpV0",
  "studio": "v3.5.0--U_f4yiM0OWw_EtyyADmAklt1SyYyBPSK9I6bKn8XYr4"
};
const checksumsStructure = {
  "content": "PJ58IAw-FOfWZA725ZYHnIub3ObJ2K_kKxshd7s90G0",
  "artists": "W2i4rZYpJhZqfhfGXR-pIeuZqFM77LIIW6mehOZzm4c",
  "exhibitions": "-A9IrStMRE4a18PaZD_GNRwW6zfetRPn5bZm3bGL_cc",
  "window": "b-u_Fxff9hdq4dMsTqOPS3E1EKNTQrqshXhMnH3zwqU",
  "viewingRooms": "HesL4dbno4__r8bdex94PJJ_s2IeRfjEHUFtFMyrGbg",
  "publications": "2StoGlAzaVI35Q2MvkyPn3BB0BW30bSqRwD6vaktAvs",
  "news": "D9E5fF9CLfS28J1yTKbqahLZscXxM3RxR4tPdXFq9rE",
  "studio": "redTdNp8_5RTccDxxvUu_6fldqfLZrdFKvMK0IttoXI"
};

const tables = {
  "content": "_content_content",
  "artists": "_content_artists",
  "exhibitions": "_content_exhibitions",
  "window": "_content_window",
  "viewingRooms": "_content_viewingRooms",
  "publications": "_content_publications",
  "news": "_content_news",
  "studio": "_content_studio",
  "info": "_content_info"
};
...
const pathFor = (c, slug) => `${collMap[c].dir}/${slug}${collMap[c].ext}`;
const ensureColl = (c) => {
  if (!(c in collMap)) throw createError$1({ statusCode: 400, statusMessage: "Unknown collection" });
  return c;
};
function toFileContents(c, item) {
  if (!(item == null ? void 0 : item.slug) || typeof item.slug !== "string") {
    throw createError$1({ statusCode: 400, statusMessage: "Missing slug" });
  }
...
const _hrvJWQ = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _tUF97u = eventHandler(async (e) => {
...
const _URQXQh = defineEventHandler(async (e) => {
  const collections = [];
...
const _KIfe5c = defineEventHandler(async (e) => {
...
const _LRLMy_ = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _NtEdIr = defineEventHandler(async (e) => {
...
const _gbt3kl = _messagesHandlerCached;
...
const _i8WiA7 = eventHandler(async (event) => {
...
const _s5wAHI = eventHandler(async (event) => {
...
const _USMvQY = lazyEventHandler(() => {
...
const _lazy_CokyGt = () => import('../routes/api/admin/_collection_.get.mjs');
const _lazy_aIlNxC = () => import('../routes/api/admin/_collection_.put.mjs');
const _lazy_wZCQBN = () => import('../routes/api/admin/_collection/_slug_.delete.mjs');
const _lazy_SWogUY = () => import('../routes/api/admin/export.get.mjs');
const _lazy_jWtIzo = () => import('../routes/api/admin/import.post.mjs');
const _lazy_BlRk2m = () => import('../routes/api/health.get.mjs');
const _lazy_jR0gye = () => import('../routes/api/links/artists.get.mjs');
const _lazy_rnpZdW = () => import('../routes/api/links/exhibitions.get.mjs');
const _lazy_WTkJ9A = () => import('../routes/api/links/news.get.mjs');
const _lazy_7XcXG1 = () => import('../routes/api/links/publications.get.mjs');
const _lazy_9AOWbv = () => import('../routes/api/links/viewing-rooms.get.mjs');
const _lazy_Zi68St = () => import('../routes/api/links/window.get.mjs');
const _lazy_fa6KBb = () => import('../routes/api/sitemap/_.get.mjs');
const _lazy_5nJfpy = () => import('../routes/renderer.mjs');
const _lazy_I6jN1H = () => import('../routes/sitemap_index.xml.mjs');
const _lazy_9NkPmb = () => import('../routes/__sitemap__/_sitemap_.xml.mjs');
const _lazy_o4aJUl = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_JPaCOo = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '/api/admin/:collection', handler: _lazy_CokyGt, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/:collection', handler: _lazy_aIlNxC, lazy: true, middleware: false, method: "put" },
  { route: '/api/admin/:collection/:slug', handler: _lazy_wZCQBN, lazy: true, middleware: false, method: "delete" },
  { route: '/api/admin/export', handler: _lazy_SWogUY, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/import', handler: _lazy_jWtIzo, lazy: true, middleware: false, method: "post" },
  { route: '/api/health', handler: _lazy_BlRk2m, lazy: true, middleware: false, method: "get" },
  { route: '/api/links/artists', handler: _lazy_jR0gye, lazy: true, middleware: false, method: "get" },
  { route: '/api/links/exhibitions', handler: _lazy_rnpZdW, lazy: true, middleware: false, method: "get" },
  { route: '/api/links/news', handler: _lazy_WTkJ9A, lazy: true, middleware: false, method: "get" },
  { route: '/api/links/publications', handler: _lazy_7XcXG1, lazy: true, middleware: false, method: "get" },
  { route: '/api/links/viewing-rooms', handler: _lazy_9AOWbv, lazy: true, middleware: false, method: "get" },
  { route: '/api/links/window', handler: _lazy_Zi68St, lazy: true, middleware: false, method: "get" },
  { route: '/api/sitemap/*', handler: _lazy_fa6KBb, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_5nJfpy, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _hrvJWQ, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _tUF97u, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: _URQXQh, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap_index.xml', handler: _lazy_I6jN1H, lazy: true, middleware: false, method: undefined },
  { route: '/__sitemap__/**:sitemap', handler: _lazy_9NkPmb, lazy: true, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _KIfe5c, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _LRLMy_, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _NtEdIr, lazy: false, middleware: true, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_o4aJUl, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_JPaCOo, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_JPaCOo, lazy: true, middleware: false, method: undefined },
  { route: '/_i18n/:locale/messages.json', handler: _gbt3kl, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _i8WiA7, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _s5wAHI, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _USMvQY, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_5nJfpy, lazy: true, middleware: false, method: undefined }
];
...
export { emojiCache as $, getRenderer as A, hasProtocol as B, relative as C, joinURL as D, replaceIslandTeleports as E, useNitroApp as F, defineCachedFunction as G, escapeValueForXml as H, withQuery as I, getHeader as J, globalSitemapSources as K, resolveSitemapSources as L, resolveSitemapEntries as M, defu as N, normaliseDate as O, childSitemapSources as P, sortInPlace as Q, useSitemapRuntimeConfig as R, useNitroUrlResolvers as S, getRouterParam as T, withoutLeadingSlash as U, withoutTrailingSlash as V, parseChunkInfo as W, getSitemapConfig as X, createSitemap as Y, prefixStorage as Z, useNitroOrigin as _, collMap as a, useOgImageRuntimeConfig as a0, fetchIsland as a1, createHeadCore as a2, normaliseFontInput as a3, theme as a4, withTrailingSlash as a5, handleCacheHeaders as a6, setHeaders as a7, hash$1 as a8, parseURL as a9, createDefu as aA, resolveUnrefHeadInput as aB, decodeHtml as aC, logger$1 as aD, toBase64Image as aE, withBase as aF, htmlDecodeQuotes as aG, sendError as aH, fontCache as aI, pascalCase as aJ, kebabCase as aK, listener as aL, setResponseHeader as aa, proxyRequest as ab, sendRedirect as ac, resolveContext as ad, H3Error as ae, klona as af, defuFn as ag, headSymbol as ah, useHead as ai, parse as aj, getRequestHeader as ak, isEqual as al, sanitizeStatusCode as am, getContext as an, setCookie as ao, getCookie as ap, deleteCookie as aq, $fetch$1 as ar, baseURL as as, createHooks as at, executeAsync as au, titleCase as av, toRouteMatcher as aw, createRouter$1 as ax, camelCase as ay, useSeoMeta as az, getRequestURL as b, createError$1 as c, defineEventHandler as d, ensureColl as e, getResponseStatusText as f, getRouterParams as g, getResponseStatus as h, appId as i, defineRenderHandler as j, buildAssetsURL as k, publicAssetsURL as l, appTeleportTag as m, appTeleportAttrs as n, getQuery as o, pathFor as p, queryCollection as q, readBody as r, setHeader as s, toFileContents as t, useStorage as u, createSSRContext as v, appHead as w, destr as x, setSSRError as y, getRouteRules as z };
